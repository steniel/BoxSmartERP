Public Class AddLocation
    ...
    Private Sub tRackNumber_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles tRackNumber.KeyPress
    ...
    Private Sub AddLocation_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        LoadData()
    End Sub
    Private Sub AddLocation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadData()
    End Sub
    Private Sub LoadData()
        Dim objRacks As AddRacks = New AddRacks
    ...
    Private Sub cmdSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSubmit.Click
        ...
        If objRacks.CheckExistingRacknumberColumn(tRackNumber.Text, cmbRackColumn.Text) = False Then
            ...
            If (tRackNumber.Text - iRes) > 1 Then
                MsgBox("Current rack number is too high, please increment by 1 only.", MsgBoxStyle.Exclamation, ApplicationTitle)
                tRackNumber.Text = iRes + 1
                tRackNumber.Focus()
                Exit Sub
            End If
            If objRacks.NewRackNumber(tRackNumber.Text, cmbRackColumn.Text) = True Then
