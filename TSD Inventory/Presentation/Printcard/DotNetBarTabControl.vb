...
Public Class DotNetBarTabControl
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        G.FillRectangle(New SolidBrush(Color.FromArgb(232, 248, 252)), New Rectangle(0, 0, ItemSize.Height + 4, Height))
        'G.FillRectangle(New SolidBrush(Color.FromArgb(150, 248, 252)), New Rectangle(0, 0, ItemSize.Height + 4, Height))
        ...
        For i = 0 To TabCount - 1
            If i = SelectedIndex Then
                ...
                myBlend.Colors = {Color.FromArgb(255, 232, 240), Color.FromArgb(255, 232, 240), Color.FromArgb(255, 232, 240)}
                ...
                'G.DrawLine(Pens.PaleVioletRed, 100, 23, 100, 100)
