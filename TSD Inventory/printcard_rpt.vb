...
Public Class printcard_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSD_Inventory.printcard_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedprintcard_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printcard_rpt = New printcard_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
